...
android {
    namespace = "com.theob.gymlogger"
    compileSdk = 36
    buildToolsVersion = "36.0.0" // match the version provisioned by shell.nix (read-only Nix store)

    defaultConfig {
        applicationId = "com.theob.gymlogger"
        minSdk = 26
        targetSdk = 36
        versionCode = 3
        versionName = "1.3"
...
dependencies {
    ...
    // Compose pinned directly (no BOM) to use Material 3 Expressive (matches Book Story).
